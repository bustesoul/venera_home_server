...
func (s *Server) maybeCompressLargePageBytes(info ResolvedPageCacheInfo, page PageRef, data []byte) ([]byte, bool) {
...
func (s *Server) WarmPageMemoryFromDiskCache(info ResolvedPageCacheInfo, page PageRef) (bool, error) {
...
func (s *Server) schedulePageMemoryWarm(info ResolvedPageCacheInfo, page PageRef) {
	if s.PageMemoryCache == nil {
		return
	}
	go func() {
...
func (s *Server) storePageCacheBytes(info ResolvedPageCacheInfo, page PageRef, data []byte) (bool, error) {
...
func (s *Server) schedulePageCacheBuild(backend Backend, info ResolvedPageCacheInfo, page PageRef) {
	go func() {
